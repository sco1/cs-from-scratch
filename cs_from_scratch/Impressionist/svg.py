...
class SVG:
    ...
    def __init__(self, width: int, height: int, bg_color: COLOR_T) -> None:
        """Generate an SVG a solid backing rectangle."""
        self.content = (
    ...
    def draw_ellipse(self, p1: Coord, p2: Coord, color: COLOR_T) -> None:  # noqa: D102
        self.content += (
